...
sudo rm -rf /opt/ocv3.3
sudo mkdir -p /opt/ocv3.3
sudo chmod a+rwx /opt/ocv3.3

mkdir -p ~/git; cd ~/git
#rm -rf  ocv3.3 ocv3.3_contrib
#git clone https://github.com/rxl194/opencv ocv3.3
#git clone https://github.com/rxl194/opencv_contrib ocv3.3_contrib
cd  ocv3.3
rm -rf ubuntu; mkdir -p ubuntu; cd ubuntu
cmake -D CMAKE_BUILD_TYPE=RELEASE \
  -D CMAKE_INSTALL_PREFIX=/opt/ocv3.3 \
  -D INSTALL_C_EXAMPLES=ON \
  -D INSTALL_PYTHON_EXAMPLES=ON \
  -D OPENCV_EXTRA_MODULES_PATH=~/git/ocv3.3_contrib/modules \
...
sudo sh -c 'echo "/opt/ocv3.3/lib" > /etc/ld.so.conf.d/opencv.conf'
sudo ldconfig
